...
function getProductFamilies() {
  return [
    ...
    { id: "unshaped", name: "Unshaped Refractories", metaLine: "Major Product Family", description: "Monolithic refractories including castables, ramming masses, and gunning materials for complex geometries and rapid installation.", idealFor: "Ladle linings, tundish, torpedo cars, and furnace repairs where seamless, joint-free linings are required.", image: "https://ifglgroup.com/wp-content/uploads/2025/03/Neutral-Ramming-Mass-1.jpg" },
