...
function getProductFamilies() {
  return [
    { id: "shaped", name: "Shaped Refractories", metaLine: "Major Product Family", description: "Fired and chemically bonded refractory bricks for working, safety, and backup linings across high-temperature industrial equipment.", idealFor: "Steel, cement, non-ferrous, glass, and petrochemical plants requiring durable, dimensionally stable linings.", image: "/images/products/refractory-brick-lining-installation.webp" },
    { id: "unshaped", name: "Unshaped Refractories", metaLine: "Major Product Family", description: "Monolithic refractories including castables, ramming masses, and gunning materials for complex geometries and rapid installation.", idealFor: "Ladle linings, tundish, torpedo cars, and furnace repairs where seamless, joint-free linings are required.", image: "https://images.unsplash.com/photo-1682317292230-c264e89e843f?w=800&q=80" },
