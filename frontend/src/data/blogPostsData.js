...
`,
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      { question: "What is the difference between castable and refractory?", answer: "\"Refractory\" is the broad category of heat-resistant materials used to line furnaces and kilns; castable is one form within that category, a monolithic, cement-bonded material that is mixed with water and poured or gunned into place, as opposed to refractory bricks, which are pre-shaped and laid like masonry. So all castables are refractories, but not all refractories are castable." },
