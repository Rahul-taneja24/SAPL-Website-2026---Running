  ...
  'shaped-refractories': {
    ...
    products: [
      ...
      },
      {
        ...
        brands: ['TRL Krosaki', 'IFGL', 'Calderys'],
        keyProperties: [
    ...
    products: [
      {
        ...
        whyChoose: 'Shanker Agencies supplies IFGL monoblock stoppers matched to your tundish well nozzle and caster type, including argon-purging designs for anti-clogging on aluminium-killed steels.',
      },
      {
        id: 'tundish-nozzles',
        ...
        whyChoose: 'Shanker Agencies supplies IFGL tundish nozzles and hot-change (TCM) systems matched to your stopper and caster, with zirconia-bore options for anti-clogging performance.',
      },
      {
        id: 'well-blocks',
        name: 'Well Blocks',
        ...
        whyChoose: 'Shanker Agencies supplies IFGL well blocks (1QC/2QC/3QC and FL-series) matched to your ladle slide-gate system and steel grade, with inner-nozzle and collector-nozzle supply.',
      },
      {
