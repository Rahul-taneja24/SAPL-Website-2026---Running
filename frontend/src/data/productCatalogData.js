  ...
  'shaped-refractories': {
    ...
    products: [
      ...
      },
      {
        ...
        grades: ['STD-28', 'STD-30', 'STD-32', 'STD-36', 'STD-40'],
        applications: [
        ...
        specs: [
          ...
          { grade: 'STD-28', al2o3: '26-30%', fe2o3: '2.5%', ap: '24-28%', ccs: '20 MPa', temp: '1250°C' },
          { grade: 'STD-32', al2o3: '30-34%', fe2o3: '2.0%', ap: '22-26%', ccs: '28 MPa', temp: '1300°C' },
          { grade: 'STD-36', al2o3: '34-38%', fe2o3: '2.0%', ap: '20-24%', ccs: '32 MPa', temp: '1350°C' },
        ],
        installation: [
      ...
      },
      {
        ...
        fullDesc: 'Insulating fire bricks (IFBs) are manufactured from refractory aggregates with carefully controlled porosity. Their low bulk density and low thermal conductivity make them ideal for backup linings and furnace insulation where minimising heat storage and heat loss is critical to energy efficiency. This range is supplied ex-CUMI under their CUMILAG (Porosint) brand name; the grade data below is CUMI\'s own published specification.',
        tempMax: '1850°C',
        images: [IMG.ifb1, IMG.ifb2],
        grades: ['IFB-23', 'IFB-25', 'IFB-26', 'IFB-28', 'IFB-29', 'IFB-30', 'IFB-32', 'IFB-B201', 'IFB-B101'],
        applications: [
          'High-temperature kiln hot face & backup lining (ceramic, metallurgical)',
          'General backup insulation behind a dense working lining',
          'Primary reformer & hydrogen transfer line backup (fertiliser, petrochemical)',
          'Secondary reformer cold face',
          'Blast furnace stoves',
          'High-temperature air pre-heaters (power generation)',
          'Heat treatment furnace linings & soaking pits backup',
        ],
        brands: ['CUMI Super Refractories (CUMILAG)', 'Perfect Insulations'],
        keyProperties: [
          { label: 'Bulk Density', value: '0.55 – 1.45 g/cc' },
          { label: 'Thermal Conductivity', value: '0.14 – 1.43 W/mK (grade-dependent)' },
          { label: 'Max Service Temp', value: 'Up to 1850°C (bubble alumina grades)' },
          { label: 'Al₂O₃ Range', value: '37% – 98.5%' },
          { label: 'Hot Face Capable', value: 'Yes — can be directly exposed to flame and combustion products' },
          { label: 'Base Materials', value: 'Calcined clay, calcined alumina, fused mullite, bubble alumina' },
        ],
        specs: [
          { grade: 'IFB-23', al2o3: '37.2%', density: '0.55 g/cc', tc: '0.17 W/mK', ccs: '1.2 MPa', temp: '1260°C' },
          { grade: 'IFB-25', al2o3: '51.7%', density: '0.80 g/cc', tc: '0.22 W/mK', ccs: '2.5 MPa', temp: '1350°C' },
          { grade: 'IFB-26', al2o3: '57.3%', density: '0.86 g/cc', tc: '0.23 W/mK', ccs: '1.8 MPa', temp: '1400°C' },
          { grade: 'IFB-28', al2o3: '67.2%', density: '0.88 g/cc', tc: '0.30 W/mK', ccs: '2.5 MPa', temp: '1540°C' },
          { grade: 'IFB-29', al2o3: '57.5%', density: '1.05 g/cc', tc: '0.33 W/mK', ccs: '3.9 MPa', temp: '1550°C' },
          { grade: 'IFB-30', al2o3: '73.6%', density: '1.12 g/cc', tc: '0.60 W/mK', ccs: '4.9 MPa', temp: '1650°C' },
          { grade: 'IFB-32', al2o3: '74.2%', density: '1.28 g/cc', tc: '0.59 W/mK', ccs: '4.9 MPa', temp: '1750°C' },
          { grade: 'IFB-B201', al2o3: '91.1%', density: '1.40 g/cc', tc: '1.38 W/mK', ccs: '12.7 MPa', temp: '1800°C' },
          { grade: 'IFB-B101', al2o3: '98.5%', density: '1.45 g/cc', tc: '1.43 W/mK', ccs: '7.4 MPa', temp: '1850°C' },
        ],
        installation: [
          'Handle with care, lower crushing strength than dense bricks',
          'Use lightweight insulating mortar matched to grade (e.g. CUMIBOND LK FX, LK 65, LM 36 or LA-series for CUMILAG grades)',
        ...
        whyChoose: 'IFBs paired with a working lining can reduce furnace shell temperatures materially and cut fuel consumption versus an uninsulated dense lining. The IFB-23 to IFB-32 grades are calcined clay/alumina or fused mullite based (up to 1750°C); IFB-B201 and IFB-B101 are bubble alumina grades for the most demanding zones, up to 1850°C, including reformer radiant wall backup and blast furnace stove applications. Shanker Agencies engineers can calculate the optimal grade and lining thickness for your application, and can supply this range as CUMI\'s CUMILAG product line on request.',
      },
      {
        id: 'cold-face-insulation-bricks',
        name: 'Cold Face Insulation Bricks (CFI)',
        shortDesc: 'Group 16 backup insulation for behind the working lining, to 900°C',
        fullDesc: 'Cold face insulation bricks (CFI) are highly porous, low-density insulating bricks designed to sit behind a dense working lining rather than in the flame path. Their job is purely thermal: cut heat loss through the shell, lower cold-face temperature, and reduce the heat stored in the lining so the furnace heats and cools faster. Classified to Group 16 (approximately 850–900°C service), they are the economical backup layer in most industrial furnace and boiler wall builds.',
        tempMax: '900°C',
        images: [IMG.ifb1, IMG.ifb2],
        grades: ['CFI Group 16'],
        applications: [
          'Backup insulation directly behind a dense working lining',
          'Boiler settings, back walls and casing insulation',
          'Furnace and kiln wall backup layers where the hot face is carried by another brick',
          'Cold-face layer in multi-layer wall builds to bring shell temperature down',
        ...
        keyProperties: [
          ...
          { label: 'Bulk Density', value: '0.85 g/cc (0.9 g/cc max spec)' },
          { label: 'Cold Crushing Strength', value: '1.4 – 1.5 MPa (8 kg/cm² min spec)' },
          { label: 'Thermal Conductivity', value: '0.20 W/mK at 350°C' },
        ...
        installation: [
          ...
          'Lay with insulating mortar, not dense fireclay mortar, or the joint becomes a heat bridge',
          'Handle carefully: at ~1.5 MPa these are far weaker than dense brick and chip easily',
          'Keep the working lining continuous — any gap lets hot gas reach the CFI layer directly',
        ],
        whyChoose: 'CFI bricks are where most of the energy saving in a furnace wall actually comes from, and they are also the layer most often under-specified. Shanker Agencies supplies CFI Group 16 with batch test certificates covering CCS, bulk density, apparent porosity, thermal conductivity and permanent linear change, so the numbers you specify are the numbers you can verify on delivery.',
      },
      {
        id: 'hot-face-kyanite-insulation-bricks',
        name: 'Hot Face Kyanite Insulation Bricks (HFK)',
        shortDesc: 'Group 23 kyanite-based insulating brick rated for direct hot-face duty to 1300°C',
        fullDesc: 'Hot face kyanite insulation bricks (HFK) are kyanite-based insulating bricks built to sit in the hot face itself, not behind it. Kyanite converts to mullite on firing, giving the brick better volume stability at temperature than an ordinary clay-based insulating brick, which is what allows it to hold a working face at up to 1300°C while keeping density and heat storage low. Classified to Group 23, HFK is the choice where you want the energy behaviour of an insulating brick without adding a separate dense working lining in front of it.',
        tempMax: '1300°C',
        images: [IMG.ifb1, IMG.ifb2],
        grades: ['HFK Group 23'],
        applications: [
          'Direct hot-face lining in furnaces and kilns operating to 1300°C',
          'Heat treatment, annealing and tempering furnace linings',
          'Kiln car decks and superstructure, where low heat storage cuts fuel per cycle',
          'Batch and intermittent furnaces with frequent heat-up / cool-down cycles',
        ...
        keyProperties: [
          ...
          { label: 'Apparent Porosity', value: '60 – 62%' },
          { label: 'Bulk Density', value: '1.15 – 1.20 g/cc' },
          { label: 'Cold Crushing Strength', value: '3.1 – 3.7 MPa (8 kg/cm² min spec)' },
        ...
        installation: [
          ...
          'Use matching insulating mortar; a dense mortar joint will conduct heat straight through the wall',
          'Cut with a hand saw rather than a hammer and chisel; the structure is porous and chips',
          'Back up with CFI Group 16 where shell temperature needs to come down further',
        ],
        whyChoose: 'HFK is the grade to specify when you want a hot face that does not store heat. The kyanite base keeps volume change under control at temperature (tested at under 1% permanent linear change after 24 hours at 1250°C), which is what separates a true hot-face insulating brick from a backup brick pushed beyond its rating. Shanker Agencies supplies HFK Group 23 with batch test certificates, and can pair it with CFI Group 16 as a complete two-layer wall.',
      },
      {
        id: 'basic-bricks',
        name: 'Basic Bricks',
        ...
        whyChoose: 'For BOF and EAF applications we stock TRL Krosaki and CUMI mag-carbon grades with carbon contents from 10–18%. Chrome-free grades (Mag-Spinel) available for environmental compliance. Dolomite brick is available on request, arranged against your specific tonnage and delivery timeline rather than held as standing stock, ask us for a quote.',
      },
      {
  ...
  'unshaped-refractories': {
    ...
    products: [
      ...
      },
      {
        ...
        grades: ['Silica Ramming', 'Alumina Ramming', 'Magnesia Ramming', 'Acidic Ramming', 'Dolomite Ramming'],
        applications: [
          ...
          'AOD and ladle back-filling, knuckle joints (Dolomite grade)',
        ],
        brands: ['Calderys India', 'TRL Krosaki', 'Mahakoshal'],
        keyProperties: [
        ...
        specs: [
          ...
          { grade: 'Alumina', al2o3: '82-92%', mgo: 'up to 12.5%', density: '2.70-2.92 g/cc', application: 'Steel induction furnace, stainless steel', temp: '1750°C' },
          ...
          { grade: 'Dolomite', mgo: '35-58%', cao: '38-59%', ccs: '—', application: 'AOD and ladle back-filling, knuckle joints, well block surround', temp: '1700°C' },
        ],
        installation: [
        ...
        whyChoose: 'Shanker Agencies supplies Calderys and TRL Krosaki ramming masses for all furnace types. We provide installation guidance and sintering programmes specific to your furnace capacity and charge material. Dolomite ramming mass for AOD back-filling and ladle knuckle joints is available on request, arranged against your requirement rather than held as standing stock.',
      },
      {
        id: 'coil-coat-patching-materials',
        name: 'Coil Coat & Patching Material',
        h1: 'Induction Furnace Coil Coat & Patching Material',
        shortDesc: 'Fused alumina coil grout and patching material for coreless induction furnace linings',
        fullDesc: 'Coil coat (coil grout) is applied over the induction coil before the working lining is rammed, protecting the coil insulation and conducting heat away from it. Patching material repairs and upgrades worn areas of an alumina-based lining between full relines. Shanker Agencies supplies both the CUMI and Saint-Gobain ranges. From CUMI: SUPER SHIELD, an ultra high temperature coil coating castable rated to 1800°C at 94% Al₂O₃ minimum, and SHIELD, rated to 1700°C at 87–90% Al₂O₃. From Saint-Gobain HeatKing™: CA 337 fused alumina coil coat, which offers significantly higher dielectric strength than silicate-bonded grouts, and PA 748 fused alumina patching material used as a primer or undercoat with alumina-based melting refractories. Choose SUPER SHIELD where peak service temperature governs, SHIELD where fired strength matters (550 kg/cm² after 1450°C), and CA 337 where dielectric protection of the coil is the priority.',
        tempMax: '1800°C',
        images: [IMG.rammingMass1, IMG.gunning1],
        grades: ['CUMI SUPER SHIELD (1800°C)', 'CUMI SHIELD (1700°C)', 'HeatKing CA 337 (Coil Coat)', 'HeatKing PA 748 (Patching)'],
        applications: [
          'Coil grout in coreless induction furnaces',
          'Protection of coil insulation against metal fin contact',
          'Priming and undercoating alumina-based melting refractories',
          'Patching worn areas of an induction furnace lining',
          'Extending a lining campaign between full relines',
        ],
        brands: ['CUMI', 'Saint-Gobain HeatKing'],
        keyProperties: [
          { label: 'Base', value: 'Fused alumina / high-alumina castable' },
          { label: 'Dielectric Strength', value: 'CA 337 significantly higher than silicate-bonded grouts' },
          { label: 'Coil Coat Water Demand', value: 'CA 337, approx. 10–12% for casting' },
          { label: 'Patching Water Demand', value: 'PA 748, 7.8–10 litres per 25 kg' },
          { label: 'Shelf Life', value: 'CUMI grades and CA 337 nine months; PA 748 one year' },
          { label: 'Packing', value: 'CUMI 25 kg LDPE-lined HDPE; CA 337 25 kg in 1 t jumbo; PA 748 50 kg or 1 MT' },
        ],
        specs: [
          { grade: 'CUMI SUPER SHIELD', al2o3: '94.0% min', density: '2.60 g/cc min (dried 110°C)', ccs: '200 kg/cm² min (dried 110°C)', application: 'Coil coating castable', temp: '1800°C' },
          { grade: 'CUMI SHIELD', al2o3: '87–90%', density: '2.50 g/cc min (dried 110°C)', ccs: '250 kg/cm² min dried; 550 min fired 1450°C', application: 'Coil coating castable', temp: '1700°C' },
          { grade: 'HeatKing CA 337', al2o3: '91.4%', density: '2.67 g/cm³ (cast & dried)', ccs: '—', application: 'Coil coat / coil grout', temp: '1750°C' },
          { grade: 'HeatKing PA 748', al2o3: '83%', density: '—', ccs: '17 MPa min (fired 1250°C)', application: 'Patching / primer / undercoat', temp: '1760°C' },
        ],
        installation: [
          'CA 337: mix with approximately 10–12% water and apply as coil grout over the coil before the working lining is rammed',
          'CA 337: allow the coat to dry fully before ramming the working lining against it',
          'PA 748: mix 7.8–10 litres of clean water per 25 kg bag, adjusting for water temperature, ambient conditions and required working time',
          'PA 748: apply to a cleaned, sound surface as a primer or undercoat, then build up the patch',
          'Both are hygroscopic, store in a cool dry place and keep bags sealed until use',
      ...
      },
      {
        ...
        grades: ['LC Gun Mix', 'HA Gun Mix', 'Mag Gun Mix', 'Silica Gun Mix', 'Tundish Spraying Mass'],
        applications: [
          ...
          'Tundish working lining, spray-applied (Tundish Spraying Mass)',
        ...
        specs: [
          ...
          { grade: 'Silica Gun Mix', sio2: '85-90% (typical range)', rebound: '15-20%', density: '1.90 g/cc', temp: '1650°C' },
          { grade: 'Tundish Spraying Mass', mgo: '70-75%', rebound: '—', density: '1.77-1.84 g/cc (dried/fired)', temp: '1650°C' },
        ],
        installation: [
        ...
        whyChoose: 'We supply gunning equipment rental alongside material for complete turnkey repair contracts. Our technicians have supervised ladle and BF trough repair campaigns across 50+ steel plants in India. Tundish Spraying Mass is TRL Krosaki grade for spray-applied tundish working lining, sintering at 750°C for a fast turnaround between casting sequences.',
      },
      {
        id: 'taphole-filling-mass',
        name: 'Taphole & Filling Mass',
        h1: 'Taphole Filling Mass for Blast Furnace and Torpedo Ladle',
        shortDesc: 'ZrO₂-Cr₂O₃ based filling mass for taphole and free-flow area maintenance',
        fullDesc: 'Taphole filling mass is packed around the taphole sleeve and free-flow areas of blast furnaces and torpedo ladle cars, where the combination of iron/slag erosion, thermal cycling and mechanical wear from tap-to-tap operation demands a chemistry tougher than a general-purpose ramming mass. A ZrO₂-Cr₂O₃ based mass resists this erosion far better than a plain alumina or silica fill, extending the interval between full taphole clay relines. Shanker Agencies supplies TRL Krosaki filling mass for this duty.',
        tempMax: '1750°C',
        images: [IMG.rammingMass1, IMG.gunning1],
        grades: ['ZrO₂-Cr₂O₃ Filling Mass'],
        applications: [
          'Blast furnace taphole and free-flow area',
          'Torpedo ladle car free-flow / taphole maintenance',
          'Iron notch and runner repair zones',
        ],
        brands: ['TRL Krosaki'],
        keyProperties: [
          { label: 'Base', value: 'ZrO₂-Cr₂O₃' },
          { label: 'Max Service Temperature', value: '1750°C' },
          { label: 'Max Grain Size', value: '≤2 mm' },
          { label: 'Shelf Life', value: '9 months from date of manufacture' },
          { label: 'Key Advantage', value: 'Erosion resistance beyond plain alumina/silica filling mass' },
        ],
        specs: [
          { grade: 'ZrO₂-Cr₂O₃ Filling Mass', zro2: '27.8%', cr2o3: '20.6%', al2o3: '2.26%', sio2: '43.1%', temp: '1750°C', application: 'Blast furnace taphole, torpedo ladle free-flow area' },
        ],
        installation: [
          'Pack around the taphole sleeve and free-flow area per the furnace OEM\'s clearance drawing',
          'Confirm compatibility with the taphole clay grade already in service before switching',
          'Store in a cool, dry, sheltered location; shelf life is 9 months from manufacture',
          'Do not mix with household waste at disposal; handle per the manufacturer\'s disposal note',
        ],
        whyChoose: 'Shanker Agencies supplies TRL Krosaki ZrO₂-Cr₂O₃ filling mass for blast furnace taphole and torpedo ladle free-flow area maintenance. Chemistry shown is taken directly from the manufacturer\'s product definition sheet, not estimated. Tell us your furnace or ladle capacity and current taphole clay grade and we will confirm compatibility and quantity.',
      },
      {
  ...
  insulation: {
    ...
    products: [
      ...
      },
      {
        ...
        fullDesc: 'Ceramic fiber products are manufactured from aluminosilicate fibres produced by melting and fiberising a blend of Al₂O₃ and SiO₂. They offer extremely low thermal mass (enabling rapid furnace heat-up and cool-down), very low thermal conductivity, and good resistance to thermal shock. Two chemistries are supplied: the standard RT grade rated to 1260°C (Al₂O₃ 45–48%, SiO₂ 52–55%), and the zirconia-bearing HTZ grade rated to 1425°C (Al₂O₃ 35–37%, SiO₂ 47–49%, ZrO₂ 14–18%) where the extra service temperature is needed. Available as blanket, module, board, vacuum-formed shapes, paper, rope and bulk wool, each suited to a different installation requirement.',
        popular: true,
        tempMax: '1425°C',
        images: [IMG.ceramicFiber1, IMG.ceramicFiber2],
        grades: ['1260°C Blanket (RT)', '1425°C Blanket (HTZ)', 'Module', 'Board', 'Vacuum-formed Shapes', 'Paper', 'Rope', 'Bulk Wool'],
        applications: [
          'Blanket: furnace wall & roof lining, boiler casing, pipe and duct wrapping',
          'Module: full hot-face lining for heat treatment and annealing furnaces (stud-welded)',
          'Board & vacuum-formed shapes: rigid backup insulation, burner blocks, custom hot-face shapes',
          'Paper: gaskets, thin thermal barriers, hot-face separators',
          'Rope: furnace and kiln door seals, flange gaskets, expansion joint packing, cable/pipe penetration seals',
          'Bulk wool: packing irregular voids, expansion joints, filling cavities behind brickwork',
          'Petrochemical reformer furnace casing insulation',
          'Steel ladle cover and torpedo car cover insulation',
        ],
        brands: ['Divine Cerawool', 'Mahakoshal', 'Crown Ceramics'],
        keyProperties: [
          { label: 'Service Temperature', value: '1260°C (RT) and 1425°C (HTZ, zirconia-bearing)' },
          { label: 'Blanket Densities', value: '64, 96, 128, 160 kg/m³' },
          { label: 'Blanket Thicknesses', value: '13 mm, 25 mm, 50 mm' },
          { label: 'Fibre Diameter', value: '2.6 – 3.5 micron' },
          { label: 'Linear Shrinkage', value: '2.5% max at 1100°C; 3.0% max at 1200°C (24 hr soak)' },
          { label: 'Heat Storage', value: 'A fraction of an equivalent dense refractory lining' },
        ],
        specs: [
          { grade: 'Blanket RT-1260', tempC: '1260°C class / 1050°C continuous', density: '64, 96, 128, 160 kg/m³', tc_500: '0.15 W/mK @128 kg/m³, 600°C', tensile: '60 kPa min', form: 'Roll 13/25mm × 610 × 7300–7620mm' },
          { grade: 'Blanket HT-1425', tempC: '1425°C class / 1350°C continuous', density: '64, 96, 128, 160 kg/m³', tc_500: '0.16 W/mK @128 kg/m³, 600°C', tensile: '60 kPa min', form: 'Roll 50mm × 610 × 3650–3810mm' },
          { grade: 'Module', tempC: '1260 / 1425°C', density: '160–200 kg/m³', tc_500: '—', tensile: '—', form: 'Folded module, stud-welded' },
          { grade: 'Board LT-1050', tempC: '1050°C class', density: '300–370 kg/m³', tc_500: '—', tensile: '2.8 kg/cm² @10% deform', form: 'Rigid sheet 12/25/50mm' },
          { grade: 'Board RT-1260', tempC: '1260°C class', density: '320–380 kg/m³', tc_500: '—', tensile: '2.8 kg/cm² @10% deform', form: 'Rigid sheet 12/25/50mm' },
          { grade: 'Board HTZ-1425', tempC: '1425°C class', density: '320–380 kg/m³', tc_500: '—', tensile: '2.8 kg/cm² @10% deform', form: 'Rigid sheet 12/25/50mm' },
          { grade: 'Vacuum Formed', tempC: '1260 / 1425°C', density: '350–400 kg/m³', tc_500: '—', tensile: '—', form: 'Custom shapes to drawing' },
          { grade: 'Paper', tempC: '1260°C', density: '160–200 kg/m³', tc_500: '—', tensile: '—', form: 'Roll, gasket/seal use' },
          { grade: 'Rope', tempC: '1260°C', density: '—', tc_500: '—', tensile: '—', form: 'Round / square / twisted; glass or SS reinforced' },
          { grade: 'Bulk Wool', tempC: '1260 / 1425°C', density: '—', tc_500: '—', tensile: '—', form: 'Loose fill, packing voids' },
        ],
        installation: [
