  ...
  'shaped-refractories': {
    ...
    products: [
      ...
      },
      {
        ...
        shortDesc: 'High-carbon basic bricks for BOF, EAF hot spots and ladle slag lines',
        fullDesc: 'Magnesia-carbon (MgO-C) bricks contain 74–90% MgO with 8–20% graphite and metallic antioxidants (Al, Si, B₄C). The combination resists basic slags, is non-wetting to steel and slag, and survives the severe thermal cycling of converters and arc furnaces. MgO-C is the standard for BOF/converter linings, EAF hot spots and steel ladle slag lines. TRL Krosaki supplies resin-bonded grades from 8% to 18% carbon.',
        tempMax: '1700°C',
