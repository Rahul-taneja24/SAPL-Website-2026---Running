  ...
  insulation: {
    ...
    products: [
      ...
      },
      {
        ...
        shortDesc: 'Electrical-grade high-temperature insulation for induction coils and heating elements',
        fullDesc: 'Mica is a naturally occurring silicate mineral that combines high-temperature resistance with excellent dielectric strength, which is what separates it from the rest of the insulation range. Where ceramic fibre and calcium silicate are chosen purely to stop heat, mica is chosen where the insulation must also block electricity — most commonly induction furnace coil insulation, heating element supports and electrical equipment operating hot. Supplied as rigid boards and plates, flexible sheet, and tape, in muscovite and phlogopite grades.',
        tempMax: '1000°C',
        images: [IMG.microporous1, IMG.microporous2],
        grades: ['Muscovite (rigid)', 'Phlogopite (rigid)', 'Flexible mica sheet', 'Mica tape'],
        applications: [
          'Induction furnace coil insulation and coil lining',
          'Heating element support and separation',
          'Electrical equipment insulation at elevated temperature',
          'High-temperature gaskets and washers where dielectric strength is needed',
          'Transformer, generator and switchgear insulation components',
          'Backing insulation for band heaters and hot plates',
        ],
        brands: ['Perfect Insulations'],
        keyProperties: [
          { label: 'Key Advantage', value: 'Dielectric strength plus heat resistance in one material' },
          { label: 'Muscovite Grade', value: 'Higher dielectric strength, lower temperature ceiling' },
          { label: 'Phlogopite Grade', value: 'Higher temperature capability, used where heat governs' },
          { label: 'Forms', value: 'Rigid board/plate, flexible sheet, tape' },
          { label: 'Machinability', value: 'Can be cut, punched and machined to shape' },
          { label: 'Chemical Nature', value: 'Naturally occurring silicate mineral' },
        ],
        installation: [
          'Cut and machine to shape before installation, mica plate can be punched and drilled',
          'For induction coil work, confirm the grade against both operating temperature and applied voltage, not temperature alone',
          'Avoid mechanical impact on rigid mica plate, it is strong in compression but brittle to edge shock',
          'Keep dry before installation, prolonged damp storage affects dielectric performance',
        ],
        whyChoose: 'Mica is specified where an insulation has to be an electrical barrier as well as a thermal one, which most refractory insulation is not. Shanker Agencies supplies mica insulation alongside the induction furnace ramming mass and refractory range, so a coil reline and its insulation can be sourced together rather than from two suppliers. Send us your coil dimensions, operating temperature and voltage and our team will confirm the grade and form.',
      },
    ],
  },
