...
function Brands() {
  ...
  const brandsStructuredData = {
    ...
    description: "Shanker Agencies is an authorised dealer of CUMI, Crown Ceramics and Divine Cerawool, and a supply partner for Calderys, TRL Krosaki, Mahakoshal and Saint-Gobain refractories in India.",
  ...
  return (
    <div className="bg-white">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(15,30,70,0.97) 0%, rgba(30,58,138,0.88) 100%), url('https://images.unsplash.com/photo-1600683550547-2c38a96fb400?w=1600&q=80')`,
