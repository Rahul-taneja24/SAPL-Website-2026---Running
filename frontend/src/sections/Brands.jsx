  ...
  return (
    <div className="bg-white">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(30,58,95,0.97) 0%, rgba(30,64,175,0.88) 100%), url('https://images.unsplash.com/photo-1600683550547-2c38a96fb400?w=1600&q=80')`,
