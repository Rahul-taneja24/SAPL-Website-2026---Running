...
const IMG = {
    /* category heroes */
    shapedHero: "https://images.unsplash.com/photo-1565363887715-c5de3b0faa0f?w=1400&q=90",
    unshapedHero: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=1400&q=90",
    flowHero: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1400&q=90",
    insulHero: "https://images.unsplash.com/photo-1601241773118-9e67091e199e?w=1400&q=90",
    acidHero: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1400&q=90",
    /* product detail */
    fireclay1: "https://images.unsplash.com/photo-1682891328125-c527a70dc69a?w=900&q=90",
    fireclay2: "https://images.unsplash.com/photo-1565363887715-c5de3b0faa0f?w=900&q=90",
    highAlumina1: "https://images.unsplash.com/photo-1708254849487-4667e1479232?w=900&q=90",
    highAlumina2: "https://images.unsplash.com/photo-1565363887715-c5de3b0faa0f?w=900&q=90",
    highAlumina3: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=900&q=90",
    ifb1: "https://images.unsplash.com/photo-1609089792573-2ec8b9e263ec?w=900&q=90",
    ifb2: "https://images.unsplash.com/photo-1682891328125-c527a70dc69a?w=900&q=90",
    basicBricks1: "https://images.unsplash.com/photo-1697281679290-ad7be1b10682?w=900&q=90",
    basicBricks2: "https://images.unsplash.com/photo-1682891328125-c527a70dc69a?w=900&q=90",
    sic1: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=900&q=90",
    lcc1: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=900&q=90",
    lcc2: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=900&q=90",
    ulcc1: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=900&q=90",
    ramming1: "https://images.unsplash.com/photo-1697281679290-ad7be1b10682?w=900&q=90",
    gunning1: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=900&q=90",
    slideGate1: "https://images.unsplash.com/photo-1697281679290-ad7be1b10682?w=900&q=90",
    slideGate2: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=900&q=90",
    shroud1: "https://images.unsplash.com/photo-1727504172743-08f14448fab8?w=900&q=90",
    ...
    acidBrick1: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=90",
    acidTile1: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=90",
    /* industry solution images */
    ...
    aluminum: "https://images.unsplash.com/photo-1727504172743-08f14448fab8?w=600&q=80",
    glass: "https://images.unsplash.com/photo-1625765362026-654dd71d07c5?w=600&q=80",
    petro: "https://images.unsplash.com/photo-1768128834332-7d3479c8d634?w=600&q=80",
    power: "https://images.unsplash.com/photo-1747345341772-7516f6b54958?w=600&q=80",
};
    ...
    "flow-control": {
        ...
        products: [
            ...
            },
            {
                ...
                tempMax: "1650°C",
                images: [IMG.slideGate1],
                grades: ["Magnesia Porous", "Alumina Porous", "Directional (slit type)", "Inner Nozzle Assembly"],
                applications: [
    ...
    return (
        <Link href={`/products/${categorySlug}/${product.id}`}
            ...
            <div className="relative h-48 overflow-hidden bg-gray-100">
                ...
                <span className={`absolute bottom-3 left-3 flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold border ${meta.pill}`}>
                    <Thermometer size={10} /> {product.tempMax || "—"}
                </span>
            </div>
            <div className="p-5 flex-1 flex flex-col">
                <h3 className="font-oswald text-[15px] font-bold text-[#1E3A5F] mb-1.5 group-hover:text-[#3B82F6] transition-colors leading-tight">
                    {product.name}
                </h3>
                ...
                {product.grades && (
                    <div className="flex flex-wrap gap-1 mb-4">
                        {product.grades.slice(0, 3).map(g => (
                            <span key={g} className="px-2 py-0.5 bg-gray-100 text-gray-600 text-[10px] font-medium rounded-md">{g}</span>
                        ))}
                        {product.grades.length > 3 && (
                            <span className="px-2 py-0.5 bg-gray-100 text-gray-400 text-[10px] rounded-md">+{product.grades.length - 3}</span>
                        )}
                    </div>
                )}
                <span className="inline-flex items-center gap-1.5 text-xs font-bold transition-all"
                    style={{ color: meta.accent }}>
                    View Specs & Details <ArrowRight size={12} className="group-hover:translate-x-1 transition-transform" />
                </span>
            </div>
        </Link>
    );
                    ...
                    <div>
                        <div className="bg-gray-50 rounded-2xl border border-gray-200 p-6 lg:sticky lg:top-24 space-y-6">
                            ...
                            <div className="space-y-3 pt-4 border-t border-gray-200">
                                ...
                                <button className="w-full flex items-center justify-center gap-2 border-2 border-[#3B82F6] text-[#3B82F6] px-4 py-3 rounded-xl font-bold text-sm hover:bg-blue-50 transition-colors">
        ...
        <div className="bg-white">
            <section className="relative py-20 px-4"
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: `${meta.accent}30` }}>
                            <Icon size={20} style={{ color: meta.accent }} />
                        </div>
                    </div>
                    <h1 className="font-oswald text-4xl sm:text-5xl font-bold text-white mb-3">{category.name.toUpperCase()}</h1>
                    <p className="text-blue-200 text-base max-w-2xl mb-6 leading-relaxed">{category.tagline}</p>
                    <div className="flex flex-wrap gap-3">
                        <span className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2 text-white text-sm font-semibold">
                            <Thermometer size={15} style={{ color: meta.accent }} /> {category.tempRange}
                        </span>
                        <span className="flex items-center gap-2 bg-white/10 rounded-xl px-4 py-2 text-white text-sm font-semibold">
                            <Package size={15} className="text-blue-300" /> {category.products.length} Products
                        </span>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto w-full relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/80 text-xs font-semibold mb-6 uppercase tracking-widest">
                            <Package size={11} /> 5 Categories · 19 Products · 80+ Grades
                        </div>
                    ...
                    <div className="mt-10 flex flex-wrap gap-8">
                        {[{ v: "5", l: "Categories" }, { v: "19", l: "Product Types" }, { v: "80+", l: "Grades" }, { v: "1850°C", l: "Max Temp" }].map(({ v, l }) => (
                            <div key={l} className="text-center">
                                <p className="font-oswald text-3xl font-bold text-[#F97316]">{v}</p>
                                ...
                                return (
                                    <Link key={cat.slug} href={`/products/${cat.slug}`}
                                        ...
                                        <div className="relative sm:w-52 flex-shrink-0 h-48 sm:h-auto overflow-hidden bg-gray-100">
                                            ...
                                            <div className="absolute inset-0 bg-gradient-to-r from-black/25 via-transparent to-transparent sm:bg-gradient-to-b sm:from-transparent sm:to-black/30" />
                                            <div className="absolute top-3 left-3 w-9 h-9 rounded-xl flex items-center justify-center shadow-lg" style={{ background: cat.accent }}>
                                        ...
                                        <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between">
                                            <div>
                                                <div className="flex items-start justify-between mb-2">
                                                    <h3 className="font-oswald text-lg sm:text-xl font-bold text-[#1E3A5F] group-hover:text-[#1E40AF] transition-colors leading-tight pr-2">
                                                        {cat.name}
                                                    </h3>
                                                    <span className="hidden sm:block flex-shrink-0 px-2.5 py-1 text-[10px] font-bold rounded-full border"
                                                        style={{ color: cat.accent, borderColor: `${cat.accent}40`, background: `${cat.accent}10` }}>
                                                        {cat.count} Products
                                                    </span>
                                                </div>
                                                <p className="text-xs text-gray-500 leading-relaxed mb-4">{cat.tagline}</p>
                                                <div className="flex flex-wrap gap-1.5 mb-4">
                                                    ...
                                                    {cat.keyProducts.length > 3 && (
                                                        <span className="px-2.5 py-1 text-[10px] text-gray-400 bg-gray-50 rounded-full border border-gray-200">+{cat.keyProducts.length - 3} more</span>
                                                    )}
                                                </div>
                                            </div>
                                            <div className="flex items-center justify-between">
                                                <span className="flex items-center gap-1.5 text-xs text-gray-500">
                                                    <Thermometer size={12} style={{ color: cat.accent }} />
                                                    <span className="font-semibold" style={{ color: cat.accent }}>{cat.tempRange}</span>
                                                </span>
                                                <span className="flex items-center gap-1.5 text-xs font-bold group-hover:gap-2.5 transition-all" style={{ color: cat.accent }}>
