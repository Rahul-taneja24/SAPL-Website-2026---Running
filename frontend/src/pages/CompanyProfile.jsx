...
function CompanyProfile() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Document */}
      <div id="company-profile-doc" className="max-w-[210mm] mx-auto bg-white shadow-xl my-0 sm:my-8 print:my-0 print:shadow-none">

        {/* PAGE 1 */}
        <section className="p-8 sm:p-10 print:p-10">
        ...
        <section className="p-8 sm:p-10 print:p-10">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-6">
            <div className="glass-card p-5 border-2 border-[#1E3A5F] rounded-xl">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3"><Phone className="text-[#3B82F6]" size={15} /><div><p className="text-xs font-semibold text-[#1E3A5F]">+91 98102 05154</p><p className="text-xs font-semibold text-[#1E3A5F]">+91 98119 09394</p></div></div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-8">
            <a href="tel:+919810205154" className="flex items-center justify-center gap-2 p-4 gradient-primary text-white rounded-xl font-oswald font-bold text-sm"><Phone size={16} /> Call Now</a>
            ...
            <a href="https://wa.me/919810205154" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 p-4 text-white rounded-xl font-oswald font-bold text-sm" style={{ backgroundColor: "#25D366" }}>
