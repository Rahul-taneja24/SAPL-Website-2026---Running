...
export const metadata = {
  title: 'Request a Refractory Quote (RFQ)',
  description:
...
export default function RfqPage() {
  return (
    <>
      ...
      {/* Hero — compact on mobile so the form starts near the first viewport;
          full spacing and type scale are preserved from `sm` upwards. */}
      <section className="bg-[#1E3A5F] py-8 sm:py-16 md:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-[10px] sm:text-xs font-semibold tracking-widest uppercase mb-3 sm:mb-4">
          ...
          <p className="text-white/75 max-w-2xl mx-auto leading-relaxed text-sm sm:text-base">
      ...
      {/* Trust bar */}
      <div className="py-3 sm:py-4 px-4 bg-gray-50 border-b border-gray-200">
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-x-5 gap-y-1.5 sm:gap-8">
          {[
            ...
            <div key={label} className="flex items-center gap-2 text-gray-600">
              <Icon size={14} className="text-[#F97316] flex-shrink-0" aria-hidden="true" />
