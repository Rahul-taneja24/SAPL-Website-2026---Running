...
export const metadata = {
  ...
  keywords: [
    ...
    'TRL Krosaki dealer', 'IFGL distributor', 'Mahakoshal refractories dealer',
    'Mahakoshal refractories distributor', 'Mahakoshal refractory supplier India',
    'Mahakoshal authorized partner', 'Mahakoshal ramming mass', 'Mahakoshal castables',
    ...
    // Competitive positioning — beating primary organic competitors
    'best refractory supplier India', 'leading refractory distributor India',
    'refractory supplier alternative to Refmon', 'alternative to Ganesha refractories',
    'alternative to Gupta Refractories', 'alternative to Lanexis',
    'Mahakoshal dealer India', 'Mahakoshal Delhi', 'Mahakoshal NCR',
    'alternative to BM Enterprises refractories', 'alternative to Onir Marketing refractories',
    'premium refractories India', 'branded refractories supplier',
    'refractory engineering Delhi NCR', 'refractory for copper smelter', 'refractory for glass furnace',
    'refractory for power plant boiler', 'since 1980 refractory supplier',
  ],
  openGraph: {
    type: 'website',
    locale: 'en_IN',
