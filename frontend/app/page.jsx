...
export const metadata = {
  ...
  description: "Shanker Agencies, India's premier refractory exporter since 1980. High alumina bricks, LCC/ULCC castables, ceramic fiber. CIF to GCC, ASEAN, Africa.",
  alternates: {
    canonical: '/',
    languages: {
  ...
  openGraph: {
    ...
    locale: 'en_IN',
    type: 'website',
    images: [{ url: '/opengraph-image.jpg', width: 1200, height: 630, alt: 'Shanker Agencies | Refractory Engineering Partner' }],
  },
};
