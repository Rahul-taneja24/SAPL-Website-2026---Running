...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspValue = [
      ...
      "img-src 'self' data: blob: https://images.unsplash.com https://www.shankeragencies.com https://shankeragencies.com https://www.cumi-murugappa.com https://maps.gstatic.com https://maps.googleapis.com",
      "font-src 'self' data:",
